...
export default function Footer() {
  return (
    <footer className="bg-[#050810] pt-20 pb-10 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="text-xl font-bold tracking-tighter text-white flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded bg-gradient-to-br from-primary to-secondary flex items-center justify-center font-bold text-white shadow-[0_0_10px_rgba(139,92,246,0.5)]">
                E
              </div>
              EbookForge <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">AI</span>
            </Link>
            <p className="text-gray-400 text-sm">
              A plataforma definitiva para criar e vender Ebooks altamente persuasivos com o poder da Inteligência Artificial.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/" className="hover:text-primary transition-colors">Tutoriais</Link></li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} EbookForge AI. Todos os direitos reservados.
          </p>
